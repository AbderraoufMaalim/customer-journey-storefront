...
const UserContext = createContext<userContextType>({ email: null, workflowId:null ,setEmail: null,setWorkflowId: null })
...
const UserProvider: FC<UserProviderProps> = ({ children }) => {
  ...
  return (
    <UserContext.Provider value={{ email, workflowId, setEmail, setWorkflowId }}>
      {children}
